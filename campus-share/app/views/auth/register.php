...
<div style="max-width: 480px; margin: 40px auto;" class="panel">
    ...
    <!-- JS Realtime Error Box -->
    <div id="js-error-msg" style="display: none; background-color: #fee2e2; color: #b91c1c; border: 1px solid #fecaca; padding: 12px; border-radius: 4px; margin-bottom: 18px; font-size: 13px; font-weight: 600;">
    </div>

    <form id="registerForm" action="index.php?route=register" method="POST" autocomplete="off" novalidate>
